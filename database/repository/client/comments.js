...
var table='comments';
var fillable=["id","goods_id","users_id","comment"];
...
function select(values,callback){
    ...
    "id": ["and","="],"goods_id": ["and","like"],"users_id": ["and","like"],"comment": ["and","like"]    };
    ...
    function users(data,callback){
        ...
        var relation= {
            ...
            conditionField: 'id'
                ...
                var conditions={
        "users.id": ["and","like"],"users.name": ["and","like"],"users.email": ["and","like"],"users.phone": ["and","like"],"users.password": ["and","like"],"users.img": ["and","like"],"users.rank": ["and","like"],"comments.id": ["and","like"],"comments.goods_id": ["and","like"],"comments.users_id": ["and","like"],"comments.comment": ["and","like"]
        };

        var selectedFields=[
        "users.id as users_id","users.name as users_name","users.email as users_email","users.phone as users_phone","users.password as users_password","users.img as users_img","users.rank as users_rank","comments.id as comments_id","comments.goods_id as comments_goods_id","comments.users_id as comments_users_id","comments.comment as comments_comment"        ];
