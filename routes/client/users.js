...
var users=require('../../database/repository/client/users');

router.get('/', function(req, res, next) {

    users.select(req.query ,function(result){
        respond(req,res,'client/users/index', { results: result,search:req.query });
    });
});
...
router.get('/goods',function(req,res,next){
    ...
    users.goods(req.query,function(results){
        respond(req,res,'client/users/goods', { results: results ,search:req.query});
    });
...
router.get('/:id/goods',function(req,res,next){
    ...
    users.offers(req.query,function(results){
        respond(req,res,'client/users/offers', { results: results ,search:req.query});
    });
...
router.get('/:id/offers',function(req,res,next){
    ...
    users.offers_comments(req.query,function(results){
        respond(req,res,'client/users/offers_comments', { results: results ,search:req.query});
    });
...
router.get('/:id/offers_comments',function(req,res,next){
    ...
    users.comments(req.query,function(results){
        respond(req,res,'client/users/comments', { results: results ,search:req.query});
    });
...
router.get('/:id/comments',function(req,res,next){
    ...
    users.raises(req.query,function(results){
        respond(req,res,'client/users/raises', { results: results ,search:req.query});
    });
...
router.get('/:id/raises',function(req,res,next){
    ...
    users.purchases(req.query,function(results){
        respond(req,res,'client/users/purchases', { results: results ,search:req.query});
    });
...
router.get('/:id/purchases',function(req,res,next){
    ...
    users.purchases_offers(req.query,function(results){
        respond(req,res,'client/users/purchases_offers', { results: results ,search:req.query});
    });
...
router.get('/:id/purchases_offers',function(req,res,next){
    ...
    users.payments(req.query,function(results){
        respond(req,res,'client/users/payments', { results: results ,search:req.query});
    });
...
router.get('/:id/payments',function(req,res,next){
    ...
    users.users_details(req.query,function(results){
        respond(req,res,'client/users/users_details', { results: results ,search:req.query});
    });
...
router.get('/:id/users_details',function(req,res,next){
    ...
    users.users_documents(req.query,function(results){
        respond(req,res,'client/users/users_documents', { results: results ,search:req.query});
    });
...
router.get('/:id/users_documents',function(req,res,next){
    ...
    users.money_transfer(req.query,function(results){
        respond(req,res,'client/users/money_transfer', { results: results ,search:req.query});
    });
...
router.get('/:id/money_transfer',function(req,res,next){
    ...
    users.charge_account(req.query,function(results){
        respond(req,res,'client/users/charge_account', { results: results ,search:req.query});
    });
...
router.get('/:id/charge_account',function(req,res,next){
    ...
    users.financial_movement(req.query,function(results){
        respond(req,res,'client/users/financial_movement', { results: results ,search:req.query});
    });
...
router.get('/create', function(req, res, next) {
    ...
    respond(req,res,'client/users/create', { values:req.query });
...
router.post('/create', function(req, res, next) {
    ...
    users.insert(req.body,function(result){
        if(result.status ==1){
            redirectRespond(req, res,'/client/users/'+result.insertId+'/edit',result);
        }else{
            respond(req,res,'client/users/create', { values:req.body });
        }
    });
...
router.get('/:id', function(req, res, next) {
    ...
    users.select({id:id},function(result){
        respond(req,res,'client/users/show', { results: result });
    });
...
router.get('/:id/edit', function(req, res, next) {
    ...
    var id=req.params.id
    users.select({id:id},function (result){
        respond(req,res,'client/users/edit', { values:result.rows[0] });
    });
...
router.post('/:id/edit', function(req, res, next) {
    ...
    users.update({id:['and','=',id]},req.body,function(result){
        respond(req,res,'client/users/edit', { values:req.body,result:result });
    });
...
router.get('/:id/delete', function(req, res, next) {
    ...
    users.deleteRow(id,function(result){
        redirectRespond(req, res,'/client/users/',result);
    });
